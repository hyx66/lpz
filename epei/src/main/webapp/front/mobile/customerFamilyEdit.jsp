...
<div class="breadcrumb">
    <div class="path"
         onclick="window.location='/servicedPerson/customerFamilyList.html'"><i><img src="/front/mobile/images/leftarrow.png"
                                                                       alt=""></i>
        <c:choose>
            <c:when test="${empty customerFamily}">
                添加家庭成员信息
            </c:when>
            <c:otherwise>
                修改家庭成员人员信息
    ...
    <jodd:form bean="customerFamily" scope="request">
        <input type="hidden" name="id"/>
            <div class="booking_box">
                <div class="formitem">
                    <input type="text" name="name" placeholder="请输入家庭成员姓名" class="input_txt" datatype="*"
                           nullmsg="请输入家庭成员姓名">
                    <div class="Validform_checktip"></div>
                </div>
                <div class="formitem">
                    <input type="text" name="phone"  class="input_txt" placeholder="请输入家庭成员电话" datatype="m"
                           nullmsg="请输入家庭成员电话" errorMsg="请输入家庭成员电话">
                    <div class="Validform_checktip"></div>
                </div>
                <div class="formitem">
                    <input type="text" name="idCard" class="input_txt" placeholder="请输入家庭成员身份证号" datatype="idcard"
                           nullmsg="请输入家庭成员身份证号" errorMsg="请输入家庭成员身份证号">
                    <div class="Validform_checktip"></div>
                </div>
                <div class="formitem">
                    <input type="text" name="relationship" class="input_txt" placeholder="请输入您与该家庭成员的关系">
                </div>
            </div>
    </jodd:form>
...
$(function(){
    ...
    $("#person_form").Validform({
        ...
        callback : function(data){
            $.post("/customerFamily/customerFamilySave.html",$("#person_form").serialize(),function(result){
                if(result.success){
                    window.location.href="/customerFamily/customerFamilyList.html";
                }
                else{
